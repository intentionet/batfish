...
rbnx_n_af_default
:
    // Is this a good idea? Almost exactly the same set of commands are valid
    // (just missing inherit and default. Extractor would need to know about DEFAULT.)
    DEFAULT rbnx_n_af_inner
;
...
:
    // Is this a good idea? Almost exactly the same set of commands are valid
    // (missing inherit, default, maximum-peers. Extractor would need to know about DEFAULT.)
    DEFAULT rbnx_n_inner
;
