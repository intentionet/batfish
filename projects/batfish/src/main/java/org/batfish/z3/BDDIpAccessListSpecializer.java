...
public final class BDDIpAccessListSpecializer extends IpAccessListSpecializer {
  ...
  public HeaderSpace specialize(HeaderSpace headerSpace) {
    return headerSpace
        ...
        .setDstIps(specializeDstIps(headerSpace.getDstIps()))
        .setNotDstIps(specializeDstIps(headerSpace.getNotDstIps()))
        ...
        .setSrcIps(specializeSrcIps(headerSpace.getSrcIps()))
        .setNotSrcIps(specializeSrcIps(headerSpace.getNotSrcIps()))
        .setTcpFlags(specializeTcpFlags(headerSpace.getTcpFlags()))
        .build();
  }

  private @Nullable IpSpace specializeDstIps(@Nullable IpSpace dstIps) {
    return dstIps == null ? null : _dstIpSpaceSpecializer.specialize(dstIps);
  }
